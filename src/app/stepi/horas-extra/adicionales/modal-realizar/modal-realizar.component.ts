...
export class ModalRealizarComponent implements OnInit {
  ...
  constructor(public activeModal: NgbActiveModal, private adicionalesService:AdicionalesService) { }
  ...
  ngOnInit() {
    ...
    if (this.idPuesto == null) {
      ...
      this.adicionalesService.puestos.subscribe( res => this.puestos = res);
