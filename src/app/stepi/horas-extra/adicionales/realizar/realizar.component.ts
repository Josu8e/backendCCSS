...
export class RealizarComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.adicionalesService.getRealizarInfo(this.authService.getUserId()).subscribe(
        (info) =>{
          ...
          // obtiene la cantidad de puestos
          this.cantPuestos = info.servicio.puestos.length;
          //obtiene los datos informativos
        ...
        .then((confirmed) => {
          ...
          if (confirmed) {
            ...
            if (this.solicitudesHePuesto.length === 0) {
              ...
              const solicitudes =  this.solicitudesHePuesto.map( solicitud => (
                {
                  ...
                  horas: solicitud.horas_solicitadas,
              ...
              this.adicionalesService.postRealizar(JSON.parse(object)).subscribe(
                ()=>{
