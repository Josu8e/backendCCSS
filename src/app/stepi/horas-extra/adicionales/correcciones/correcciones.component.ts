...
export class CorreccionesComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private adicionalesService: AdicionalesService,
  ...
  ngOnInit() {
    ...
    this.adicionalesService.getCorrecciones(this.authService.getUserId()).subscribe(
      (info) =>{
        this.informacion = info;
        this.adicionalesService.actualizarPuestos(Object.assign([],this.informacion.servicio.puestos));
        ...
        // se obtiene la cantidad de puesto asociados
        ...
        // lanza alerta para advertir que los datos en el campo horas autorizadas son datos por defecto, debido a la falta de los mismos 
  ...
  enviarSolictud() {
    ...
    .then((confirmed) => {
      if (confirmed) {
        ...
        this.adicionalesService.putCorrecciones(JSON.parse(object)).subscribe(
          ()=>{
