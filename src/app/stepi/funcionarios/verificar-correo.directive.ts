...
@Directive({
  selector: '[ngx-verificarCo][formControlName],[verificarCo][formControl],[verificarCo][ngModel]',
  providers: [{ provide: NG_VALIDATORS, useExisting: VerificarCorreoDirective, multi: true }],
})
export class VerificarCorreoDirective implements Validator {
  ...
  validate(control: FormControl): { [key: string]: any; } {
    ...
    return (p === true) ? { 'verificarCo': true } : null;
  }
